---
name: phase-status
description: Produce a read-only, self-updating progress dashboard across all Document Intelligence Platform build phases. Use when the user asks for phase status, build readiness, blockers, sequencing violations, gaps, or the next phase to build.
---
