...
| D06 | Traefik Ingress and Certificates | Gate 11 (Traefik is live) | **Partial** | Traefik runs but is not yet scraped; needs a metrics entrypoint and scrape job. Certificate panels need cert-manager (not yet deployed). |
